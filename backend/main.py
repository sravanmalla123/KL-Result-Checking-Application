...
def run_single_engine(engine: str, req: EvaluationRequest) -> dict:
    ...
    # Scan text for explicit statements of AI image generation or household photos
    text_lower = req.text.lower()
    has_ai_tool = any(k in text_lower for k in ["midjourney", "dall-e", "stable-diffusion", "stable diffusion", "photoshop", "gimp", "canva"])
    has_ai_image_term = any(k in text_lower for k in [
    ...
    household_terms = ["selfie", "family photo", "family picture", "my dog", "my cat", "pet photo", "photo of my", "picture of my", "household photo", "personal photo"]
