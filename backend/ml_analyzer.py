...
def evaluate_report_ml(filename: str, text: str, images: list, simulation_scenario: str = "valid", engine: str = "gemini") -> dict:
    ...
    text_lower = text.lower()
    has_ai_tool = any(k in text_lower for k in ["midjourney", "dall-e", "stable-diffusion", "stable diffusion"])
    has_ai_image_term = any(k in text_lower for k in ["ai-generated image", "ai generated image", "image generated by ai", "synthetic image", "ai diagram", "ai-generated diagram", "ai generated diagram"])
